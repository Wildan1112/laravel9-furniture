<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h2 class="font-semibold text-lg text-slate-700 leading-tight mb-5">Transaction Details</h2>
            ...
            <h2 class="font-semibold text-lg text-slate-700 leading-tight mb-5">Transaction Item</h2>
