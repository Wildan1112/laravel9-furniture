    ...
    <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
            <div class="w-full md:hidden px-4">
                ...
                <span class="text-xl font-bold">IDR {{ number_format($product->price, 0, '', '.') }}</span>
            </div>
            <div class="flex-1">
                <div class="slider">
                    <div class="thumbnail">
            ...
            <div class="flex-1 px-4 md:p-6">
                ...
                <p class="text-xl font-bold">IDR {{ number_format($product->price, 0, '', '.') }}</p>
                ...
                <h6 class="text-xl font-semibold mb-4">Detail</h6>
                ...
                @foreach ($recommendations as $recommendation)
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            ...
                            <span class="">{{ number_format($recommendation->price, 0, '', '.') }}</span>
